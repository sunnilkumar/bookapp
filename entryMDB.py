...
app.config['MONGODB_HOST'] = "mongodb+srv://user2000:user2000@cluster0.dttievp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
def login():
    ...
    # # Save the new Entry document to the database
    new_entry.save()
